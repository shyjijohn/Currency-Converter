    ...
    return (
        ...
        <div>
            <div className=' md:absolute m-5 flex flex-row items-center'>
                <div>
                    <img src={`${process.env.PUBLIC_URL}/Images/currency.png`} alt="currency" className="object-contain w-10 h-10 mr-2" />
                </div>
            ...
            <div className=" flex gap-4 flex-col-reverse md:flex-row lg:flex-row xl:flex-row 2xl:flex-row justify-around">
                <div className=" min-w-fit w-7/12 h-auto">
                    ...
                    <img src={`${process.env.PUBLIC_URL}/Images/currency-converter-clipart.jpg`} alt="currency" className="object-contain min-w-44 w-full h-screen" />
                </div>
